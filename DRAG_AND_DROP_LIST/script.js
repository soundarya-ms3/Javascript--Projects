...
function dragStart(e){
    initialX = isTouchDevice() ? e.touched[0].clientX : e.clientX;
...
const drop = (e) =>{
    e.preventDefault();
    let newX = isTouchDevice() ? e.touched[0].clientX : e.clientX;
    let newY = isTouchDevice() ? e.touched[0].clientY : e.clientY;
